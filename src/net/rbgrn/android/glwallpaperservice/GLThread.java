...
class GLThread extends Thread {
	...
	private GLWallpaperService.EGLConfigChooser mEGLConfigChooser;
	...
	GLThread(GLWallpaperService.Renderer renderer, GLWallpaperService.EGLConfigChooser chooser,
             EGLContextFactory contextFactory, EGLWindowSurfaceFactory surfaceFactory, GLWrapper wrapper) {
		super();
		mDone = false;
		mWidth = 0;
		mHeight = 0;
